...
/*package*/ class AttributeConnector_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public AttributeConnector_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_i2dest_a");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.role$m760;
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_i2dest_b0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.targetType$m77w;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.targetType$r4_l);
    ...
    provider.setEmptyCellId("empty_" + "targetType");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.targetType$m77w);
    }
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfo(editorCell, referenceLink, CONCEPTS.PrimitiveType$p7));
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "[");
    editorCell.setCellId("Constant_i2dest_d0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_RIGHT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createProperty_2() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.constraint$DHG8;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "]");
    editorCell.setCellId("Constant_i2dest_f0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private static final class PROPS {
    /*package*/ static final SProperty role$m760 = MetaAdapterFactory.getProperty(0x9859e7a148764909L, 0xa6648a214c206698L, 0x355f4a6bd0f1302cL, 0x355f4a6bd0f1302dL, "role");
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink targetType$r4_l = MetaAdapterFactory.getReferenceLink(0x9859e7a148764909L, 0xa6648a214c206698L, 0x5b448949fec5dbfeL, 0x5b448949fecbd515L, "targetType");
  }
}
