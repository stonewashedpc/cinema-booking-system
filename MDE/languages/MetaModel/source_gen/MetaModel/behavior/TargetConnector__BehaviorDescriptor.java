...
public final class TargetConnector__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9859e7a148764909L, 0xa6648a214c206698L, 0x355f4a6bd0f1302fL, "MetaModel.structure.TargetConnector");
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    Scope s = ScopeProvider__BehaviorDescriptor.getScope_id52_Geb4QDV$.invoke0(__thisNode__, CONCEPTS.ScopeProvider$M8, kind, child);
    return s;
    //  Hier muss gemäß  der Dokumentation (z.B. Buch I, S. 125) gefiltert werden, so dass Assoziationen nicht mehr enthalten sind 

  }

  /*package*/ TargetConnector__BehaviorDescriptor() {
  }
